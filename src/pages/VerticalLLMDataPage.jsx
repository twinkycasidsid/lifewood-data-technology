...
const featureItems = [
  { label: "Autonomous Driving Annotation", sub: "2D & 3D object annotation at scale", dot: "amber" },
  { label: "In-Vehicle Data Collection", sub: "Structured sensor & camera pipelines", dot: "green" },
  { label: "Enterprise & Private LLM Pipelines", sub: "End-to-end domain data workflows", dot: "amber" },
  { label: "Domain-Specific AI Training Data", sub: "Industry-vertical curated datasets", dot: "green" },
];
...
const WavyFeatureCard = ({ item, i, inView }) => {
  ...
  // Each letter of the label gets a staggered wave on hover
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: hovered
          ? item.dot === "amber"
            ? "0 6px 24px rgba(232,160,32,0.10)"
            : "0 6px 24px rgba(4,98,65,0.08)"
              ...
              animate={
                hovered
                  ? {
                      ...
                      color: [
                        C.dark,
                        item.dot === "amber" ? C.amber : C.green,
                        C.dark,
                      ],
                    }
                  : { y: 0, color: C.dark }
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        .vlld-page { font-family: 'Manrope', sans-serif; background: ${C.bg}; min-height: 100vh; color: ${C.dark}; }
        .vlld-hero-grid { display: grid; grid-template-columns: 1.1fr 1fr; gap: 48px; align-items: center; }
        @media (max-width: 900px) {
          .vlld-hero-grid { grid-template-columns: 1fr !important; }
          .vlld-process-grid { grid-template-columns: 1fr !important; }
          .vlld-sticky { position: static !important; }
          .vlld-hero-inner { padding: 52px 24px 48px !important; }
          .vlld-process-section { padding: 52px 24px 64px !important; }
          .vlld-quote-section { padding: 52px 24px 64px !important; }
        }
        @media (max-width: 540px) {
          .vlld-hero-inner { padding: 40px 18px 36px !important; }
          .vlld-process-section { padding: 36px 16px 52px !important; }
          .vlld-quote-section { padding: 40px 16px 52px !important; }
        }
      `}</style>

      <main className="vlld-page">
        ...
        <section style={{
          ...
          <div ref={heroRef} className="vlld-hero-inner" style={{
            ...
            <div className="vlld-hero-grid">
              ...
              <div>
                ...
                >
                  Specialized AI Data for{" "}
                  <span style={{ color: C.amber }}>Vertical LLM</span> Systems.
                </motion.h1>
                ...
                >
                  AI data solutions built for specific industry verticals — from autonomous driving annotation and in-vehicle data collection to enterprise-grade, domain-specific LLM training pipelines.
                </motion.p>
        ...
        {/* ── PROCESS ── */}
        <section className="vlld-process-section" style={{
          ...
          <div ref={processRef} style={{ maxWidth: 1160, margin: "0 auto", position: "relative", zIndex: 1 }}>
            <div className="vlld-process-grid" style={{
              display: "grid", gridTemplateColumns: "1fr 1.8fr",
              gap: "clamp(36px, 6vw, 80px)", alignItems: "start",
            }}>
              {/* Sticky left */}
              <div className="vlld-sticky" style={{ position: "sticky", top: 88 }}>
                <motion.div
                  initial={{ opacity: 0, x: -20 }}
                ...
                >
                  ...
                  <p style={{
                    ...
                    From initial annotation targets through to scaled production — here's how a vertical LLM data engagement unfolds end to end.
                  </p>
        ...
        {/* ── QUOTE ── */}
        <section ref={quoteRef} className="vlld-quote-section" style={{
          ...
          <div style={{
            ...
            >
              ...
              <blockquote style={{
                ...
                "Specialized AI systems demand specialized data: deep domain context, precise annotation, and rigorous quality assurance are the foundations of safe, scalable vertical LLM outcomes."
              </blockquote>
...
export default VerticalLLMDataPage;